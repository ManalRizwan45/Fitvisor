<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="transformationJ.aspx.cs" Inherits="WebApplication2.transformationJ" %>
...
<body bgcolor="#E6C500">
    ...
    <td align="right" width="9%"><a href="ContactUs.aspx">Contact Us</a></td>
                ...
                <h1 align="center"  style="font:Arial, Helvetica, sans-serif;font-size:70px">Transformation Journeys&nbsp;</h1>
             <asp:GridView ID="GridView1" runat="server" Width="100%" RowStyle-Height="100px">
             </asp:GridView>
        <br />
            <br />
             <br />
